/**
 * LineaInvestigacion Repository
 * -------------------
 * Este repositorio contiene TODAS las consultas directas a la base
 * relacionadas con la tabla `LineaInvestigacion` y sus tablas puente.
 *
 * IMPORTANTE:
...
export const LineaInvestigacionRepository = {

    // TODO: obtener LineaInvestigacion por id
    async getById(id: number) { /* implementar */ },

    // TODO: obtener todos los LineaInvestigacion
    async getAll() { /* implementar */ },

    // TODO: obtener LineaInvestigacion con filtros básicos
