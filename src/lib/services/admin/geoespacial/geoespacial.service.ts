...
import { institucionesRepository } from '$lib/db/admin/geoespacial/geoespacialInstituciones.repository';
import { facultadesRepository } from '$lib/db/admin/geoespacial/geoespacialFacultades.repository';
import { carrerasRepository } from '$lib/db/admin/geoespacial/geoespacialCarreras.repository';
import { validateGeoJSON } from '$lib/models/admin/geoespacial/geoespacial.dto';
import type {
	Institucion,
	Facultad,
	Carrera,
